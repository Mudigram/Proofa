 ...
 * FAB "+" opens a speed dial with 3 document creation options.
 */
"use client";
...
export default function BottomNav() {
    ...
    const navItems = [
        ...
        { label: "Create", href: "#", icon: Plus, isFAB: true },
                            ...
                            if (item.isFAB) {
                                return (
                                    <button
                                        ...
                                        aria-label={isCreateOpen ? "Close create menu" : "Create new document"}
                                    >
                                        <motion.div
