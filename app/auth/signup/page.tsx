        ...
        <main className="app-container min-h-screen flex flex-col justify-center py-10 bg-gradient-to-b from-orange-50/50 via-white to-surface-50 dark:from-surface-950 dark:via-surface-900 dark:to-surface-950 relative transition-colors duration-200">
            ...
            >
                ...
                <div className="text-center mb-8 pt-2">
                    ...
                    <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full text-[10px] font-black uppercase tracking-wider mb-2">
                        <Sparkles size={12} />
                        Free Account Setup
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <Building2 size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-surface-400" aria-hidden="true" />
                            <input
                                type="text"
                                value={name}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <Mail size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-surface-400" aria-hidden="true" />
                            <input
                                type="email"
                                value={email}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-surface-400" aria-hidden="true" />
                            <input
                    ...
                    <p className="text-center text-surface-400 text-xs font-medium mt-1">
