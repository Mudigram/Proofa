...
export default function BrandIdentityPage() {
        ...
        return (
            <main className="app-container min-h-screen pb-24 pt-8">
                <header className="mb-8 flex items-center justify-between relative">
                    ...
                    <div className="h-6 w-32 bg-surface-200 dark:bg-surface-700 animate-pulse rounded-lg absolute left-1/2 -translate-x-1/2" />
                    <div className="w-10 h-10" />
                </header>

                <div className="space-y-6">
                    {[1, 2, 3].map(i => (
                        <div key={i} className="bg-white dark:bg-surface-900 border-2 border-surface-100 dark:border-surface-800 rounded-[2rem] p-6 shadow-sm">
                            <div className="flex items-center gap-3 mb-6">
                                <div className="w-10 h-10 bg-surface-50 dark:bg-surface-800 animate-pulse rounded-xl" />
                            ...
                            <div className="h-32 w-full bg-surface-50 dark:bg-surface-800 animate-pulse rounded-2xl" />
                        </div>
                    ))}
                </div>
            </main>
    ...
    if (!isPro) {
        return (
            <main className="app-container min-h-screen pb-24 pt-8 flex flex-col">
                <header className="mb-8 flex items-center justify-between relative">
                    <button onClick={() => router.back()} className="w-10 h-10 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-800 rounded-full flex items-center justify-center text-surface-600 dark:text-surface-300 shadow-sm active:scale-95 transition-all">
                        <ChevronLeft size={20} />
                    </button>
                    <h1 className="text-xl font-black text-surface-900 dark:text-surface-50 tracking-tight absolute left-1/2 -translate-x-1/2">Brand Identity</h1>
                    <div className="w-10 h-10"></div>
                </header>

                <div className="flex-1 flex flex-col items-center justify-center text-center px-4 -mt-20">
                    <div className="w-24 h-24 bg-gradient-to-br from-purple-100 to-primary-50 dark:from-purple-950/60 dark:to-primary-950/60 rounded-3xl flex items-center justify-center text-purple-500 mb-6 shadow-xl shadow-purple-500/10 rotate-3">
                    ...
                    <div className="flex -space-x-3 mb-8">
                        {PRESET_COLORS.slice(0, 4).map(c => (
                            <div key={c.id} className="w-8 h-8 rounded-full border-2 border-white dark:border-surface-950 shadow-sm" style={{ backgroundColor: c.hex }} />
                        ))}
                    </div>
                    <Link
                        href="/pricing"
    ...
    return (
        <main className="app-container min-h-screen pb-24 pt-4">
            ...
            {/* Logo Section */}
            <div className="bg-white dark:bg-surface-900 border-2 border-surface-100 dark:border-surface-800 rounded-[2rem] p-6 shadow-sm mb-6">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 bg-primary-50 dark:bg-primary-950/60 text-primary-500 rounded-xl flex items-center justify-center">
                        <Sparkles size={20} />
                    </div>
                    <div>
                        <h2 className="font-extrabold text-black dark:text-surface-50">Permanent Logo</h2>
                        <p className="text-[11px] font-bold text-surface-400 dark:text-surface-500 uppercase tracking-widest">Saved & restored automatically</p>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-surface-900 border-2 border-surface-100 dark:border-surface-800 rounded-[2rem] p-6 shadow-sm mb-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h2 className="font-extrabold text-black dark:text-surface-50">Preferred Currency</h2>
                        <p className="text-[11px] font-bold text-surface-400 dark:text-surface-500 uppercase tracking-widest">Defaults for all forms</p>
                    </div>
                </div>
                    ...
                    {CURRENCIES.map((curr) => (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-4 rounded-[1.5rem] border-2 transition-all active:scale-95 ${selectedCurrency === curr.code
                                ...
                                : "bg-surface-50 dark:bg-surface-800 border-surface-100 dark:border-surface-700 text-surface-400 dark:text-surface-300 hover:border-surface-200 dark:hover:border-surface-600"
                                }`}
                        >
            ...
            <div className="bg-white dark:bg-surface-900 border-2 border-surface-100 dark:border-surface-800 rounded-[2rem] p-6 shadow-sm mb-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h2 className="font-extrabold text-black dark:text-surface-50">Primary Brand Color</h2>
                        <p className="text-[11px] font-bold text-surface-400 dark:text-surface-500 uppercase tracking-widest">Headings & Main Totals</p>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-surface-900 border-2 border-surface-100 dark:border-surface-800 rounded-[2rem] p-6 shadow-sm mb-6">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 bg-blue-50 dark:bg-blue-950/60 text-blue-500 rounded-xl flex items-center justify-center">
                        <Palette size={20} />
                    </div>
                    <div>
                        <h2 className="font-extrabold text-black dark:text-surface-50">Accent Color</h2>
                        <p className="text-[11px] font-bold text-surface-400 dark:text-surface-500 uppercase tracking-widest">Icons & Secondary Details</p>
                    </div>
                </div>
                ...
                <div className="mt-8 p-6 rounded-2xl border-2 border-dashed border-surface-200 dark:border-surface-700 flex flex-col items-center justify-center bg-surface-50 dark:bg-surface-800">
                    <p className="text-xs font-bold text-surface-500 dark:text-surface-400 mb-4 uppercase tracking-widest">Preview</p>
            ...
            {errorMsg && (
                <div className="bg-red-50 dark:bg-red-950/50 border border-red-100 dark:border-red-900 text-red-600 dark:text-red-400 text-sm font-bold px-4 py-3 rounded-xl mb-6">
                    {errorMsg}
                </div>
            )}
            {successMsg && (
                <div className="bg-green-50 dark:bg-green-950/50 border border-green-100 dark:border-green-900 text-green-600 dark:text-green-400 text-sm font-bold px-4 py-3 rounded-xl mb-6">
                    {successMsg}
                </div>
            )}
            ...
            <button
                ...
                className="w-full bg-surface-900 dark:bg-surface-800 text-white font-black py-4 rounded-2xl shadow-xl shadow-surface-900/20 active:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:shadow-none"
            >
                {isSaving ? (
            ...
            <p className="text-[10px] text-surface-400 dark:text-surface-500 font-black uppercase tracking-[0.15em] text-center mt-4">
